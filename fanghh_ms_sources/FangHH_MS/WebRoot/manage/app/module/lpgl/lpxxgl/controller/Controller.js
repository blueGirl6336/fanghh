Ext.define('HRMS.module.lpgl.lpxxgl.controller.Controller', {
	...
	views : 'HRMS.module.lpgl.lpxxgl.view.*',
	buildingId: 0,
...
//				title : '人员基本信息',
				...
				},
				{
					...
					items : [{
						...
						editable:false,
						fieldLabel : '是否为热销楼盘',
						name : 'sellingHotlabel',
						xtype : 'combobox',
						value : record.data.sellingHotlabel,
						store : 
							Ext.create('Ext.data.Store', {
							    // reader configs
							    fields: ['name','code'],
						...
						name : 'buildingType',
						xtype : 'combobox',
						value : record.data.buildingType,
						store : 
						Ext.create('Ext.data.Store', {
						    // reader configs
						    fields: ['name','code'],
						    data : [{'name': '海景楼盘','code':2},
								    {'name': '普通楼盘','code':1}]
						}),
						valueField : 'code',
						displayField : 'name'
						...
						name : 'sellingHotSort',
						xtype : 'numberfield',
						value : record.data.sellingHotSort,

Ext.define('HRMS.module.pjgl.zygwpjgl.view.ConsultantCommentFromBroker',
		{
			extend : 'Ext.grid.Panel',
			alias : 'widget.consultantCommentFromBrokerPanel',
			layout : 'fit',
			title : '评价一览',
			border : 0,
			frame : true,
			...
			enableLocking : false,
			store : Ext.create(
					'HRMS.store.building.ConsultantCommentFromBrokerStore'),
			initComponent : function() {
				...
				store.proxy.api.read = "consultantCommentFromBroker/getAll";
...
//					})	
			...
			searchComment : function() {
				...
				var store = this.store;
				store.proxy.api.read = "consultantCommentFromBroker/search";
				store.proxy.actionMethods = {
					read : 'POST'
				};

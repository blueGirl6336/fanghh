...
public class HouseStyleServiceImpl implements HouseStyleService
{
	...
	public String addStyle(HouseStyleBean houseStyleBean)
	{
		...
		houseStyle.setSpecialitiesPic(houseStyleBean.getSpecialitiesPic());
		...
		houseStyle.setStylePic(houseStyleBean.getStylePic());
	...
	public String updateStyle(HouseStyleBean houseStyleBean)
	{
		...
		} else if (houseStyleBean.getApplicationStatus().equals(DictionaryString.APPLICATION_OFF_SALE))
		{
		...
		houseStyleBean.setSpecialitiesPic(houseStyleBean.getSpecialitiesPic());
		...
		houseStyleBean.setStylePic(houseStyleBean.getStylePic());

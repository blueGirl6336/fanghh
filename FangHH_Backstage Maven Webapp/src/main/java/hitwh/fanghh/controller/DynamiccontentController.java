...
public class DynamiccontentController
{
	...
	{
		return ResponseMapUtil.responseListMap(dynamiccontentService.getAllDynamicContent());
	}

	@RequestMapping("/getDynamicContentByBdiId")
	@ResponseBody
	public Map<String, Object> getDynamicContentByBdiId(@RequestParam int bdiId, @RequestParam int pageMaxNum,
			@RequestParam int pageNo)
	{
		return ResponseMapUtil
				.responseListMap(dynamiccontentService.getDynamicContentByBdiId(bdiId, pageMaxNum, pageNo));
	}

	@RequestMapping("/getDynamicContentPageNum")
	@ResponseBody
	public Map<String, Object> getDynamicContentPageNum(@RequestParam int pageMaxNum, @RequestParam int bdiId)
	{
		int num = dynamiccontentService.getDynamiccontentPageNum(pageMaxNum, bdiId);

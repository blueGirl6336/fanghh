...
public class BuildingController {
	...
	@ResponseBody
	public Map<String, Object> getBuildingByRegionId(
			@RequestParam int regionId, HttpSession session) {
		return ResponseMapUtil.responseListMap(buildingService
				.getBuildingByRegionId(regionId));
	}
	...
	@ResponseBody
	public Map<String, Object> addBuildingPic(
			@RequestBody Buildingpic buildingpic) {
	...
	@RequestMapping("/getAllBuildingCommentInfo")
	@ResponseBody
	public Map<String, Object> getAllBuildingCommentInfo(
			@RequestParam int pageMaxNum, @RequestParam int pageNo,
			HttpSession session) {
		return ResponseMapUtil.responseListMap(buildingComment
				.getAllBuildingCommentInfo(pageMaxNum, pageNo));
	}

	@RequestMapping("/getBuildingCommentPageNum")
	@ResponseBody
	public Map<String, Object> getBuildingCommentPageNum(
			@RequestParam int pageMaxNum, HttpSession session) {
		return ResponseMapUtil.responseObjectMap(buildingComment
				.getBuildingCommentPageNum(pageMaxNum));
	}

	@RequiredPermission
	@RequestMapping("buildingCommentCheckInfo")
	@ResponseBody
	public Map<String, Object> buildingCommentCheckInfo(
			@RequestParam int commentId, @RequestParam boolean checkResult) {

		boolean resultCode = buildingComment.buildingCommentCheckNotPass(
				commentId, checkResult);

		if (resultCode) {
			return ResponseMapUtil.responseSuccess("楼圈点评审核成功");
		} else {
			return ResponseMapUtil.responseError("楼圈点评审核失败");
		}
	}

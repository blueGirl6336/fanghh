...
public class ExceptionAdvice
{
	...
	{
		return ResponseMapUtil.responseError("access_denied");
	}
	...
	public Map<String, Object> handleMethodArgumentTypeMismatchException(Exception e)
	{
		return ResponseMapUtil.responseError("illegal_argument");
	}

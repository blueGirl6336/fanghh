...
public class AuthenticationServiceImpl implements AuthenticationService
{
	...
	public String authenticateUser(int userId, boolean status , String failedReason) {
		...
		if(status)
		{
			...
			auditStatus = DictionaryString.AUDIT_PASS;
		}else
		{
		...
		int res1 = brokerDao.updateUserAuthentation(userId, brokerType,failedReason,auditStatus);
	...
	public List<UserAuthenticationBean> getAllUser(int pageMaxNum, int pageNo)
	{
		...
		for (Broker broker : brokerList)
		{
			...
			userAuthenticationBean.setStatus(broker.getStatus());
	...
	@Override
	public List<UserAuthenticationBean> getUserBySearchKeyUserNameAndKeyRealNameAndIdNum(String keyRealName, String keyUserName , String IdNum ,int pageMaxNum, int pageNo) 
	{
		// TODO Auto-generated method stub
		int pageNum = getUserAuthenticationPageNum(pageMaxNum);
		PageCalculate pageCalculate = new PageCalculate(pageNum, pageMaxNum, pageNo);
		List<Broker> userList = brokerDao.selectByKeyUserNameAndKeyRealNameAndIdNum(keyRealName, keyUserName, IdNum, pageCalculate , DictionaryString.USER_AUTHENTICATION_APPLICATED);
		List<UserAuthenticationBean> userAuthenticationBeanlList = new ArrayList<UserAuthenticationBean>();

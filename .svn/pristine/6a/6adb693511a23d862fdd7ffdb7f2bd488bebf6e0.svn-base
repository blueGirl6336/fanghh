Ext.define('HRMS.module.xtgl.rsglsz.ejdwgl.controller.Controller', {
	...
	views : [ 'HRMS.module.xtgl.rsglsz.ejdwgl.view.DictionaryDepartmentList',
			'HRMS.module.xtgl.rsglsz.ejdwgl.view.DictionarySubunitList' ],
	...
	addDictionaryItem : function() {
        ...
        var parentCode = smRecord.data.code;
        var max = '29'+ parentCode.substring(4) + '00';
        for (var i in array) {

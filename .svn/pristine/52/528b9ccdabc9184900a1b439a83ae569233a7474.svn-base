...
public class HouseController
{
	 ...
	 * 
	 * @param houseId
	 *            applicationType (true 上架申请 false 下架申请)
	 * @return
	 */
	 ...
	 * 
	 * @param houseId
	 *            auditResult(false 不通过 true 通过) notPassReason（不通过原因， 通过填null）
	 * @return
	 */
	...
	@ResponseBody
	public Map<String, Object> addPerferentialPrice(@RequestParam int houseId,
			@RequestParam BigDecimal perferentialPrice)
	{
	...
	@RequestMapping("/uploadHousePic")
	@ResponseBody
	public Map<String, Object> uploadHousePic(MultipartFile file)
	{
		String res = houseService.uploadHousePic(file);
		if (res != null)
		{
			return ResponseMapUtil.responseSuccess(res);
		} else
